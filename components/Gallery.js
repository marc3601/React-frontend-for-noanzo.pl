      ...
      <section className={styles.container}>
        {!loading &&
          images?.map((auction, i) => {
            ...
            if (
              auction.gif !== undefined &&
              auction.gif.url.length > 0 &&
              auction.gif.width > 0
            ) {
            ...
            return (
              <Link key={auction.id + i} href={"/" + auction.id} passHref>
                <a
                ...
                >
                  ...
                  />
                  {height > 300 && (
                    <aside className={styles.image_title}>
                      <p>{auction.title}</p>
                    </aside>
                  )}
                </a>
